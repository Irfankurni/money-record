...
public class HistoryService {
    ...
    public HomeRes getPerWeek(String userId) throws Exception {
        HomeRes homeRes = historyDao.getPerWeek(userId);
        MonthRes monthRes = new MonthRes();
        monthRes.setIncome(historyDao.getIncomePerMonth(userId));
        monthRes.setOutcome(historyDao.getOutcomePerMonth(userId));
